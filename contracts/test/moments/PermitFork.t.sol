...
contract PermitForkTest is Test {
    ...
    function setUp() public {
        ...
        factory = new MomentsFactory(gov, MomentTypes.Policy({threshold: 10_000_000, minPrice: 100_000, creatorBps: 2_000, platformBps: 500, reserveBps: 7_500, maxCreatorAllocBps: 1_000, platform: makeAddr("platform")}));
        ...
        (id,,) = factory.publish(MomentsFactory.PublishParams({name: "Fork Moment", symbol: "FORK", provenance: MomentTypes.Provenance("ipfs://x", keccak256("x"), "Accra", 1_780_000_000), price: 1_000_000, creatorAllocBps: 1_000, salt: bytes32(0)}));
