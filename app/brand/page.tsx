...
export default function Brand() {
  return <main className="brand-page">
    <nav className="brand-nav"><Wordmark/><div><Link href="/">Open app preview ↗</Link><a href="/brand/dyorhq-mark.png" download>Download logo ↓</a></div></nav>
